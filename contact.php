                    ...
                    <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Our Office</h4>
                                <p class="m-0 text-white"><?php echo $res['company_address']; ?></p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Email Us</h4>
                                <p class="m-0 text-white"><?php echo $res['company_email']; ?></p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Call Us</h4>
                                <p class="m-0 text-white"><?php echo $res['company_phone']; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 mb-5 my-lg-5 py-5 pl-lg-5">
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" method="post" novalidate="novalidate">
                            ...
                            <div>
                                <button onclick="addContactMessage(this.form)" class="btn btn-primary py-3 px-5" type="button" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
