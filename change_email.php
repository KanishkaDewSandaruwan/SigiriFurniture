        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="mb-4 mb-md-0 text-primary text-uppercase">Change Email</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <i class="fas fa-angle-double-right text-primary mx-2"></i>
                        <a class="btn btn-outline-primary disabled" href="">Change Email</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 border-right">
                            <div class="p-3 py-5">
                                ...
                                <form method="POST" class="row g-3 needs-validation" novalidate
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <a href="profile.php" class="btn btn-secondary" data-bs-dismiss="modal">Back to Profile</a>
                                    </div>
